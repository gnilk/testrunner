## Resolved bugs / cleanups — archive

Archived from `todo/open-bugs.md` on 2026-07-06 to keep the active file lean. Everything below is
**resolved** (each links its fix branch/commit) or superseded. Still-open items stayed in
`todo/open-bugs.md`.
